...
class TestValidRegistrationRT:
    def setup(self):
        self.open()
    def open(self):
        self.driver = webdriver.Chrome('./Program Files/Google/Chrome/chromedriver.exe')
        self.driver.get("https://b2c.passport.rt.ru")
        WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable((By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_BUTTON_REGISTER)))
        self.driver.find_elements(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_BUTTON_REGISTER).click()
    def close(self):
        self.driver.quit()
    def teardown(self):
        self.close()
    #1 Базовый тест
    def test_baza(self):
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_FIRSTNAME).send_keys(Valid_Data.valid_first_name)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(Valid_Data.valid_last_name)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_NUMBER_OR_EMAIL).send_keys(Invalid_Data.fake_email)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_PASSWORD).send_keys(Invalid_Data.fake_password)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_PASSWORD_CONFIRM).send_keys(Invalid_Data.fake_password)
    ...
    def test_registration_user_with_pass_21char(self):
        ...
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(Valid_Data.valid_last_name)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_NUMBER_OR_EMAIL).send_keys(Invalid_Data.fake_email)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_PASSWORD).send_keys(Invalid_Data.password_21_char)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_PASSWORD_CONFIRM).send_keys(Invalid_Data.password_21_char)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_BUTTON_SUBMIT).click()
...
# 11
    ...
    def test_registration_user_with_lastname_31char(self):
        ...
        assert self.driver.find_element(By.XPATH, RTRegistrationsAllerts.LOCATOR_RT_REGISTRATION_ALLERTS_ERROR)
# 12
    @allure.feature('Регистрация с верными данными номер телефона, положительный тест')
    def test_registration_user_valid_phone(self):
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_FIRSTNAME).send_keys(
            Valid_Data.valid_first_name)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(
            Valid_Data.valid_last_name)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_NUMBER_OR_EMAIL).send_keys(Valid_Data.valid_phoneNumber)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_PASSWORD).send_keys(Valid_Data.valid_password)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_BUTTON_SUBMIT).click()
# 13
    @allure.feature('Регистрация с верными данными email, положительный тест')
    def test_registration_user_valid_email(self):
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_FIRSTNAME).send_keys(Valid_Data.valid_first_name)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(Valid_Data.valid_last_name)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_NUMBER_OR_EMAIL).send_keys(Valid_Data.valid_email)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_PASSWORD).send_keys(Valid_Data.valid_password)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_BUTTON_SUBMIT).click()